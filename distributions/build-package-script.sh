...
if ! [ `curl -s -o /dev/null -w "%{http_code}" https://github.com/puug/kong/tree/$KONG_BRANCH` == "200" ]; then
...
# Install Kong
cd $TMP
git clone --branch $KONG_BRANCH --depth 1 https://github.com/puug/kong.git
cd kong
